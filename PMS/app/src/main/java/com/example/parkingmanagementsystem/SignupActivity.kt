...
class SignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.signupButton.setOnClickListener {
            ...
            val signupEmail = binding.signupUserEmail.text.toString()
    ...
    private fun signupUser(username: String, useremail: String, password: String){
        databaseReference.orderByChild("useremail").equalTo(useremail).addListenerForSingleValueEvent(object : ValueEventListener{
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                if(!dataSnapshot.exists()){
                    ...
                    val userData = UserData(id, username, useremail, password)
